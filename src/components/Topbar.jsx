...
import ClockWidget from './topbar/ClockWidget';
import WeatherWidget from './topbar/WeatherWidget';
import BatteryWidget from './topbar/BatteryWidget';
import FocusTimer from './topbar/FocusTimer';
import SystemWidget from './topbar/SystemWidget';
import ProfileWidget from './topbar/ProfileWidget';
...
export default function Topbar({ onOpenQuickSwitcher }) {
  ...
  // ---------------------------------------------------------------------
  // Rendu d'un module de l'en-tête. La disposition (quels modules, dans
  // quelle zone, dans quel ordre) vient des paramètres — voir
  // src/lib/topbarLayout.js et Paramètres → Apparence → En-tête.
  // ---------------------------------------------------------------------
